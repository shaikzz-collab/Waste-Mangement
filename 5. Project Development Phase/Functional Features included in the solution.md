...
This document details the functional features built into **WasteGuide AI** for user testing and evaluation.

---

## 1. Feature 1: Intelligent Waste Classifier (Home Page)
